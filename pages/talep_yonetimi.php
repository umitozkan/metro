                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="kt-section__body">
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Talep Sahibi</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <select class="form-control">
                                                                                <option>Talep Sahibi Seçiniz...</option>
                                                                                <option value="id">Bahasa Indonesia - Indonesian</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Talep Sahibi Tipi</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <select class="form-control">
                                                                                <option>Talep Sahibi Tipi Seçiniz...</option>
                                                                                <option value="id">Bahasa Indonesia - Indonesian</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input class="form-control" type="text"
                                                                                   value="umit@umitozkan.com.tr">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Adress</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <select class="form-control">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Talep Nedeni</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <select class="form-control">
                                                                                <option>Talep Nedeni Seçiniz...</option>
                                                                                <option value="id">Bahasa Indonesia - Indonesian</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
